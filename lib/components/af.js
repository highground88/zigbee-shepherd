...
function dispatchIncomingMsg(type, msg) {
    ...
    console.log("Checkpoint 1", type, JSON.stringify(msg));
    ...
    if (msg.hasOwnProperty('endpoint')) {                                               // dataConfirm, reflectError
        ...
        console.log("Checkpoint 2", msg.dstendpoint);

        if (msg.dstendpoint == 11) {
            console.log("Checkpoint 2.1", "modify endpoint from 11 to 1");
            msg.dstendpoint = 1;
        }

        targetEp = coord.getEndpoint(msg.dstendpoint);               //  => find local ep

        console.log("Checkpoint 3", targetEp);
    ...
    switch (type) {
        ...
        case 'zclIncomingMsg':
            ...
            console.log("Checkpoint 4", targetEp ,"=====", JSON.stringify(msg));
